...
final class SchemaMigrationPlanTests: XCTestCase {
    ...
    func testCollegeSchemaMigrationPlan_stages() {
        XCTAssertEqual(CollegeSchemaMigrationPlan.schemas.count, 2)
        XCTAssertEqual(CollegeSchemaMigrationPlan.stages.count, 1)
    }
    ...
    func testFactorySchemas_useCollegeSchemaV1Version() {
        XCTAssertEqual(CollegeModelContainerFactory.profileSchema.version, CollegeSchemaV1.versionIdentifier)
        XCTAssertEqual(CollegeModelContainerFactory.catalogSchema.version, CollegeSchemaV1.versionIdentifier)
    }
