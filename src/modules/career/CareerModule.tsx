              ...
              <div className="flex h-full gap-2.5 overflow-x-auto pb-1">
                {statuses.map((status) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className="flex items-center gap-2 border-b border-[var(--color-chrome-stroke)] px-3 py-2.5"
                        style={{
                          background: `linear-gradient(90deg, color-mix(in srgb, ${laneColor[status]} 12%, transparent), transparent)`,
                        }}
                      >
                        <LaneDot color={laneColor[status]!} />
                        <span className="text-[12px] font-semibold tracking-[-0.01em]">
                          {statusLabels[status]}
                        </span>
                        <StatusChip
                          title={String(lane.length)}
