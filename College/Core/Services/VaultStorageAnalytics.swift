// VaultStorageAnalytics.swift
// Feature: Core
// Purpose: Core module — CourseStorageStat.
...
final class VaultStorageAnalytics: ObservableObject {
    ...
    var topStaleFiles: [VaultDocument] {
    ...
    func refresh() async {
        ...
        for doc in docs {
            let key = doc.category.isEmpty ? CollegePersistence.VaultDocumentCategory.other.rawValue : doc.category
    ...
    func staleFiles(from docs: [VaultDocument]) -> [VaultDocument] {
