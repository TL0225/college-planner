    ...
    private func pickFolder() {
        ...
        panel.begin { response in
            ...
            Task { @MainActor in
                ...
                CoreDataManager.shared.addWatchedFolder(path: url.path, bookmarkData: bookmarkData)
            }
        }
    }
    ...
    private func grantCloudFolderAccess(for provider: CloudIntegrationService.Provider) {
        ...
        panel.begin { response in
            ...
            Task { @MainActor in
                ...
                _ = CoreDataManager.shared.addWatchedFolder(path: path, bookmarkData: bookmarkData)
                cloudIntegration.refreshDetectedProviders()
            }
        }
    }
