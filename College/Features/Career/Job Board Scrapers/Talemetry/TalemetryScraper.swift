...
// Feature: Career / Job Board Scrapers / Talemetry
// Purpose: Talemetry / Jobvite job board scraper.
    ...
    private func scrapeJobviteHosted(
        ...
        for match in regex.matches(in: html, range: range) {
            ...
            listings.append(ScrapedJobListing(
                ...
                jobTypeText: nil,
                timeType: nil,
                listingHash: JobListingHash.compute(title: title, locationsText: nil)
            ))
        }
