// WorkdayBranding.swift
// Feature: Career
// Purpose: Career module — WorkdayCompanyLogoStore.
...
@MainActor
final class WorkdayCompanyLogoStore: ObservableObject {
    static let shared = WorkdayCompanyLogoStore()
    ...
    func image(for company: WorkdayCompanyConfigEntry) -> NSImage? {
        imagesBySlug[company.normalizedSlug]
    }

    func loadLogoIfNeeded(for company: WorkdayCompanyConfigEntry) {
