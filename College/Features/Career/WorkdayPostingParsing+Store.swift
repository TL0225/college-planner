// WorkdayPostingParsing+Store.swift
// Feature: Career
...
extension WorkdayPostingParsing {
    static func sortDate(for posting: WorkdayJobPosting) -> Date {
        posting.postedAt
    ...
    static func daysPostedBucket(for posting: WorkdayJobPosting) -> WorkdayDaysPostedFilter {
    ...
    static func matchesDaysPostedFilter(
        _ posting: WorkdayJobPosting,
        filter: WorkdayDaysPostedFilter
    ) -> Bool {
