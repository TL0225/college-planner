...
enum CareerListTableTheme {
    ...
    static let columnResume: CGFloat = 300
    static let columnTargetRole: CGFloat = 180
    static let columnResumeDate: CGFloat = 120
    static let columnResumeActions: CGFloat = 36
}
