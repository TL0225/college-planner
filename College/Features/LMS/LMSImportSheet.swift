// LMSImportSheet.swift
import CollegeCalendar
// Feature: LMS
// Purpose: LMS module — LMSImportSheet.
...
// grades, or announcements detected on the current LMS page.

struct LMSImportSheet: View {
    ...
    @Binding var items: [LMSImportItem]
    ...
    private var pageType: LMSPageType {
    ...
    private var sheetTitle: String {
        ...
        default:             return String(localized: "lms.import_sheet.title", defaultValue: "Import from Learning Management System")
        }
    }
    ...
    private func matchCourse(for item: LMSImportItem) -> PlannerCourse? {
        ...
        Task { @MainActor in
            ...
            for item in selected {
                ...
                switch item.pageType {
                    case .assignment:
                        // Skip duplicates keyed by lmsItemId
                        if !collegePersistence.taskExists(lmsItemId: item.lmsItemId) {
                    ...
                    case .announcement:
                        // Dedup by lmsAnnouncementId
                        if !collegePersistence.announcementExists(lmsAnnouncementId: item.lmsItemId) {
                            ...
                            let eventID = collegePersistence.addCalendarEvent(
                                ...
                                course: course,
                                notes: item.description,
                                lmsAnnouncementId: item.lmsItemId
                            )
            ...
            if let err = firstError {
                ...
                appNotifications.post(
                    kind: .success,
                    title: String(localized: "lms.import.success_title", defaultValue: "LMS Import"),
...
private struct ImportItemRow: View {
    @Binding var item: LMSImportItem
