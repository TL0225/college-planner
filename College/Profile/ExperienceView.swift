...
struct ExperienceCard: View {
    @ObservedObject var experience: ExperienceEntity
    @EnvironmentObject var modalCoordinator: ModalCoordinator
...
struct AddExperienceView: View {
    ...
    let experience: ExperienceEntity?  // nil for add, non-nil for edit
            ...
            VStack(spacing: 0) {
                ...
                HStack(spacing: 12) {
                    ...
                    if isEditMode, let exp = experience {
                        Button(action: {
                            coreDataManager.deleteExperience(exp)
