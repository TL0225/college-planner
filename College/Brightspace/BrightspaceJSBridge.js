...
(function () {
    ...
    function extractAssignment() {
        ...
        return [{
            ...
            brightspaceItemId: location.href
        }];
    }
    ...
    function extractGrades() {
        ...
        return Array.from(rows).map(function (row) {
            ...
            return {
                ...
                brightspaceItemId: location.href + '#' + cells[0].textContent.trim()
            };
    ...
    function extractAnnouncement() {
        ...
        return Array.from(items).map(function (item, i) {
            return {
                ...
                brightspaceItemId: location.href + '#item' + i
            };
        });
    }
    ...
    window.__brightspaceExtract = function () {
