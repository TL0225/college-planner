...
struct CreateTaskTool: AIAssistantTool {
    ...
    let descriptor = AssistantToolDescriptor(
        ...
        sourceLabel: "TaskEntity via CoreDataManager.addTask"
    )
...
struct CreateCalendarEventTool: AIAssistantTool {
    ...
    let descriptor = AssistantToolDescriptor(
        ...
        sourceLabel: "CalendarEventEntity via CoreDataManager.addCalendarEvent"
    )
...
struct UpdateTaskTool: AIAssistantTool {
    ...
    let descriptor = AssistantToolDescriptor(
        ...
        sourceLabel: "TaskEntity via CoreDataManager.updateTask"
    )
...
struct UpdateCalendarEventTool: AIAssistantTool {
    ...
    let descriptor = AssistantToolDescriptor(
        ...
        sourceLabel: "CalendarEventEntity via CoreDataManager.updateCalendarEvent"
    )
...
struct DeleteTaskTool: AIAssistantTool {
    ...
    let descriptor = AssistantToolDescriptor(
        ...
        sourceLabel: "TaskEntity via CoreDataManager.deleteTask"
    )
...
struct DeleteCalendarEventTool: AIAssistantTool {
    ...
    let descriptor = AssistantToolDescriptor(
        ...
        outputSchemaDescription: "title",
        sourceLabel: "CalendarEventEntity via CoreDataManager.deleteCalendarEvent"
    )
