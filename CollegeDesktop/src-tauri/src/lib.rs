...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::career::career_list_path_goals,
            commands::career::career_upsert_path_goal,
            commands::career::career_delete_path_goal,
            commands::career::career_get_path_scenario,
            commands::career::career_save_path_scenario,
            commands::career::career_get_path_disclosure,
            commands::career::career_save_path_disclosure,
            commands::career::career_migrate_pathing_settings,
